...
abstract class ProductManagementRemoteDatasourceInterface {
  ...
  /// [product] - Product data to create using BarcodeUploadModel format
  /// [token] - Bearer token for authentication
  ...
  /// [product] - Updated product data using BarcodeUploadModel format
  /// [token] - Bearer token for authentication
