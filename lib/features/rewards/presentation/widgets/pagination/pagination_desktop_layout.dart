...
class RewardsViewPaginationDesktopLayout extends StatelessWidget {
  ...
  const RewardsViewPaginationDesktopLayout({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Expanded(
          child: RewardsViewPaginationResultsInfo(
